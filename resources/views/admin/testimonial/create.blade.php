            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-check">
                        <input type="radio" name="status" id="active" value="1" class="form-check-input" required>
                        <label for="active" class="form-check-label">Active</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" name="status" id="inactive" value="0" class="form-check-input" required>
